...
<?php
  ...
  $photo->upload($_FILES['file_upload']);
    if($photo->process_media()){
        ...
        redirect('inicio.php?open=Medias');
    } else{
...
?>
  <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Lista de imágenes</h6>
            </div>
            <div class="card-body">
            ...
            <div class="pull-right">
              ...
              <div class="form-group">
                <div class="input-group">
                     <span>Las imagenes de tener un tam. 200px (ancho) x 200px (largo).</span>
