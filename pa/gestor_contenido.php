...
if(isset($_GET['open'])) {
	switch($_GET['open']){
		...
		case 'Productos' :
			if(!file_exists ("productos.php")) die ("Página principal vacía!");
		...
		case 'Calendario' :
			if(!file_exists ("calendario.php")) die ("Página principal vacía!");
			include "calendario.php"; break;

		case 'Categorias' :
			if(!file_exists ("categorias.php")) die ("Página principal vacía!");
			include "categorias.php"; break;
            
            
		case 'Agregarproducto' :
			if(!file_exists ("add_product.php")) die ("Página principal vacía!");
			include "add_product.php";	 break;
            
            
        case 'editar_producto' :
			if(!file_exists ("edit_product.php")) die ("Página principal vacía!");
			include "edit_product.php"; break;    
