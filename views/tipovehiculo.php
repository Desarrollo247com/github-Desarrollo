<?php
  $page_title = 'Listado de tipo de vehiculo';
  require_once('../includes/load.php');
  // Checkin What level user has permission to view this page
  page_require_level(1);
  
  $all_marcas = find_all('tbl_tipovehiculo');
...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">TIPO DE VEHICULOS</h3>
              <P>Agrega las diferentes tipos del vehículo del mercado</P>
            </div>
            <div class="card-body">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar tipo de vehículo</span>
         </strong>
        </div>
        <div class="panel-body">
          <form method="post" action="agrega_tipo.php">
            <div class="form-group">
                <input type="text" class="form-control" name="tipo-name" placeholder="Escribe el tipo de vehículo" required>
